...
// Program Name  : TaiwanIdValidator.cs
// Description   : iit Web SDK 中檢查台灣各種 ID 公用函數
// Version		 : Ver 1.0.0.0
// Create Author : Golden Jiang 2025/06/08 15:50 建立於 D:\Golden\TSB2\Product\iitSDKWeb\iitToolsWeb 目錄
// Update Record :
// Note          :
//===================================================================================================
//---------------------------------------------------------------------------------------------------
...
namespace iitToolsWeb
{
    public class TaiwanIdValidator
    {
        ...
        public static bool IsGuiNumberValid( string input)
        {
        ...
        } // end of public static bool IsGuiNumberValid( string input)
        ...
        /// <param name="input"></param>
        /// <returns>bool</returns>
        public static bool IsNationalIdentificationNumberValid( string input)
        {
        ...
        } // end of public static bool IsNationalIdentificationNumberValid( string input)
        ...
        /// <param name="input"></param>
        /// <returns>bool</returns>
        public static bool IsResidentCertificateNumberValid( string input)
        {
            ...
            return VerifyTaiwanIdIntermediateString(input);
        } // end of public static bool IsResidentCertificateNumberValid( string input)
        ...
        /// <param name="input"></param>
        /// <returns>bool</returns>
        public static bool IsCitizenDigitalCertificateValid( string input)
        {
            return new Regex("^([A-Z]{2})(\\d{14})$").IsMatch(input);
        } // end of public static bool IsCitizenDigitalCertificateValid( string input)
        ...
        /// <param name="input"></param>
        /// <returns>bool</returns>
        public static bool IsEInvoiceCellPhoneBarcodeValid( string input)
        {
            return new Regex("^\\/[\\dA-Z.\\-+]{7}$").IsMatch(input);
        } // end of public static bool IsEInvoiceCellPhoneBarcodeValid( string input)
        ...
        /// <param name="input"></param>
        /// <returns>bool</returns>
        public static bool IsEInvoiceDonateCodeValid( string input)
        {
            return new Regex("^[\\d]{3,7}$").IsMatch(input);
        } // end of public static bool IsEInvoiceDonateCodeValid( string input)
        ...
        private static readonly Dictionary<string, string> CityCodeDic = new Dictionary<string, string>()
        {
            ...
            { "S", "26" }, // 高雄縣
            { "Y", "31" }, // 陽明山管理局
        }; // end of private static readonly Dictionary<string, string> CityCodeDic = new Dictionary<string, string>()
        ...
        private static readonly Dictionary<char, char> ResidentCertificateNumberDic = new Dictionary<char, char>()
        {
            ...
            { 'Y', '1' },
            { 'Z', '3' },
        }; // end of private static readonly Dictionary<char, char> ResidentCertificateNumberDic = new Dictionary<char, char>()
        ...
        private static bool VerifyTaiwanIdIntermediateString( string id )
        {
            ...
            return result % 10 == 0;   
        } // end of private static bool VerifyTaiwanIdIntermediateString( string id)
    } // end of TaiwanIdValidator
} // end of namespace iitToolsWeb
//===================================================================================================
// End of TaiwanIdValidator.cs
//===================================================================================================
